        ...
        <header className="w-full fixed top-0">
            ...
            <nav className="py-5" id="lg-nav">
                <div className="px-4 md:px-6 lg:px-8 xl:px-10 flex justify-between items-center">
                    <Image src={Logo} alt="my sass logo" height={40} width={40} className="z-[999]"/>
                    <MenuIcon
            ...
            <nav
                className={`absolute top-0 left-0 w-full h-screen bg-black transition-all duration-500 ${
